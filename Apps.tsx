    ...
    >
      ...
      >
        ...
        {products.slice(0, visibleCount).map((product) => (
          ...
          >
            <img
              src={product.image.replace("h=150&w=200", "h=200&w=300")}
              alt={product.name}
              style={{
                borderRadius: 12,
                objectFit: "cover",
      ...
      {selectedProduct && (
        ...
        >
          ...
          >
            ...
            <img
              src={selectedProduct.image.replace(
                "h=150&w=200",
                "h=350&w=500"
              )}
      ...
      {viewCheckout && (
        ...
        >
          ...
          >
            ...
            <h3
              style={{ margin: "20px 0 10px 0", fontSize: 22, fontWeight: 600 }}
            >
